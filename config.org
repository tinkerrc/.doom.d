...
(map! :leader
      ...
      :desc "Fish shell functions"      :ni "f f"       (cmd! (consult-find "~/.config/fish/functions/"))
      :desc "Oh My Fish"                :ni "o"         (cmd! (consult-find "~/.config/omf"))
      :desc "dot config"                :ni "e"         (cmd! (consult-find "~/.config/")))
#+end_src
** Quick Calc
#+begin_src emacs-lisp :tangle yes
...
(map! :map org-roam-mode-map
      ...
      (:prefix ("r" . "org-roam")
       ...
       :desc "Find File"                        :ni  "."        (cmd! (consult-find org-directory))
       ))
#+end_src
